# 🛠️ Scrimba JavaScript Challenges

This repository serves as a centralized "Mega Repo" containing a collection of interactive frontend mini-projects built during the Scrimba JavaScript course. The core objective is to master vanilla JavaScript fundamentals, event handling, and dynamic DOM manipulation.

---

## 📁 Projects Dashboard

| # | Project Name | Description | Key Concepts Applied | Status |
| :-: | :--- | :--- | :--- | :-: |
...
* **Environment:** Local Workspace / VS Code

## 💻 How to View Any Project Locally
1. Clone this repository: `git clone [Your GitHub Repository Link]`
2. Open any project directory (e.g., `/01-passenger-counter/`).
3. Launch the `index.html` file using the **Live Server** extension in VS Code.